...
@EndUserText.label: 'igst value for sa doc'
...
define view entity ZFI_GSTR2_TAX_AMT_ISA
  as select from I_OperationalAcctgDocItem
{
  ...
  key FiscalYear,
      ...
      @Semantics.amount.currencyCode: 'CompanyCodeCurrency'
      cast(
      case when GLAccount = '0000148000' then cast(AmountInTransactionCurrency as abap.dec(15,2)) else 0 end
      as abap.dec(15,2))                                                                  as IGSTAmtDec,
      //    sum(case when GLAccount = '0000148003' then AmountInTransactionCurrency else 0 end) as IGSTAmtDec,

      @Semantics.amount.currencyCode: 'CompanyCodeCurrency'
      cast(
      case when GLAccount = '0000148012' then cast(AmountInTransactionCurrency as abap.dec(15,2)) else 0 end
      as abap.dec(15,2))  as RIGST
...
where
  ...
  and(
       GLAccount              = '0000148000'
    or GLAccount              = '0000148012'
  )
